      ...
      ">
        ...
        ">
          ...
          <a
            ...
            "
            onmouseover="this.style.color='#1ebe57';this.style.transform='translateY(-2px)';"
            onmouseout="this.style.color='#25D366';this.style.transform='none';"
          >
            ...
            <span style="font-size: 14px;">${safePhone}</span>
          </a>
        </div>
      </div>
    </div>
